...
RUN unzip -d $ANDROID_SDK_ROOT/cmdline-tools cmdline-tools.zip
...
RUN sdkmanager "extra-android-m2repository"
RUN sdkmanager "extra-google-google_play_services"
RUN sdkmanager "extra-google-m2repository"
