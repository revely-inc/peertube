 ...
 *
 * @author https://github.com/jeremyrempel/yahnapp/blob/main/app/src/main/java/com/github/jeremyrempel/yanhnapp/ui/components/HtmlText.kt
 */
@Composable
fun Html(html: String, handleLink: (String) -> Unit) {
