 ...
 * @author rbenjami
 */
class OverviewFragment : LayoutFragment<FragmentOverviewBinding>(R.layout.fragment_overview)
{
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?)
	{
		...
		adapter = VideosAdapter(args.host, appExecutors) {
			val direction =
				OverviewFragmentDirections.actionOverviewToVideo(
					args.host, it.id
				)
	...
	{
		videosViewModel.videos.observe(this, Observer {
