 ...
 * @author rbenjami
 */
class RecentFragment : LayoutFragment<FragmentRecentBinding>(R.layout.fragment_recent)
{
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?)
	{
		...
		adapter = VideosAdapter(args.host, appExecutors) {
			val direction =
				RecentFragmentDirections.actionRecentToVideo(
						args.host, it.id
				)
	...
	{
		videosViewModel.videosRecent.observe(this, Observer {
