 ...
 * @author rbenjami
 */
class TrendingFragment : LayoutFragment<FragmentTrendingBinding>(R.layout.fragment_trending)
{
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?)
	{
		...
		adapter = VideosAdapter(args.host, appExecutors) {
			val direction =
				TrendingFragmentDirections.actionTrendingToVideo(
					args.host, it.id
				)
	...
	{
		videosViewModel.videosTrending.observe(this, Observer {
